				...
				<div class="tt-col-left">
					<div class="tt-col-item tt-logo-col">
						...
						<a class="tt-logo tt-logo-alignment" href="index.html">
							<img src="{{asset('vendor/images/custom/logo.jpeg')}}" alt="">
						</a>
						<!-- /logo -->
					</div>
					...
					<div class="row">
						<div class="col-12 col-lg-6">
							...
							<div class="tt-modal-product">
								<div class="tt-img">
									<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/product/product-01.jpg" alt="">
								</div>
					...
					<div class="row">
						<div class="col-12 col-md-5 col-lg-6">
							<div class="tt-mobile-product-slider arrow-location-center">
								<div><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-01.jpg')}}" alt=""></div>
								<div><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-01-02.jpg')}}" alt=""></div>
								<div><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-01-03.jpg')}}" alt=""></div>
								<div><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-01-04.jpg')}}" alt=""></div>
								<div>
									<div class="tt-video-block">
										<a href="#" class="link-video"></a>
										<video class="movie" src="{{asset('vendor/video/video.mp4')}}" poster="{{asset('vendor/video/video_img.jpg')}}"></video>
									</div>
								</div>
							</div>
						</div>
										...
										<ul class="tt-options-swatch options-large">
											<li><a class="options-color" href="#">
												<span class="swatch-img">
													<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/custom/texture-img-01.jpg" alt="">
												</span>
												<span class="swatch-label color-black"></span>
											</a></li>
											<li class="active"><a class="options-color" href="#">
												<span class="swatch-img">
													<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/custom/texture-img-02.jpg" alt="">
												</span>
												<span class="swatch-label color-black"></span>
											</a></li>
											<li><a class="options-color" href="#">
												<span class="swatch-img">
													<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/custom/texture-img-03.jpg" alt="">
												</span>
												<span class="swatch-label color-black"></span>
											</a></li>
											<li><a class="options-color" href="#">
												<span class="swatch-img">
													<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/custom/texture-img-04.jpg" alt="">
												</span>
												<span class="swatch-label color-black"></span>
											</a></li>
											<li><a class="options-color" href="#">
												<span class="swatch-img">
													<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/')}}images/custom/texture-img-05.jpg" alt="">
												</span>
												<span class="swatch-label color-black"></span>
											</a></li>
										</ul>
