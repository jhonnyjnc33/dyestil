					...
					<form>
						...
						<div class="search-results">
							<ul>
								<li>
						            <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-03.jpg')}}" alt=""></div>
						        ...
						        <li>
						           <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-02.jpg')}}" alt=""></div>
						            	<div class="tt-description">
						            		<div class="tt-title">Flared Shift Bag</div>
						            		<div class="tt-price">
												$24
						        ...
						        <li>
						           <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-01.jpg')}}" alt=""></div>
						            	<div class="tt-description">
						            		<div class="tt-title">Flared Shift Bag</div>
						            		<div class="tt-price">
												$14
						        ...
						        <li>
						           <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-04.jpg')}}" alt=""></div>
						            	<div class="tt-description">
						            		<div class="tt-title">Flared Shift Bag</div>
						            		<div class="tt-price">
												$24
						        ...
						        <li>
						           <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-05.jpg')}}" alt=""></div>
						            	<div class="tt-description">
						            		<div class="tt-title">Flared Shift Bag</div>
						            		<div class="tt-price">
												$17
						        ...
						        <li>
						           <a href="product.html">
						            	<div class="thumbnail"><img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-06.jpg')}}" alt=""></div>
						            	<div class="tt-description">
						            		<div class="tt-title">Flared Shift Bag</div>
						            		<div class="tt-price">
												$20
						...
						<div class="tt-cart-content">
							<div class="tt-cart-list">
								...
								<div class="tt-item">
									<a href="product.html">
										<div class="tt-item-img">
											<img src="{{asset('vendor/images/loader.svg')}}" data-src="{{asset('vendor/images/product/product-02.jpg')}}" alt="">
										</div>
										<div class="tt-item-descriptions">
											<h2 class="tt-title">Flared Shift Dress</h2>
											<ul class="tt-add-info">
